import { PrismaClient, UserStatus, TicketStatus, TicketPriority, ArticleStatus } from '../generated/prisma';
...
async function main() {
  ...
  const regularUser = await prisma.user.upsert({
    where: { email: 'user@cueit.com' },
    update: {},
    create: {
      clerkId: 'user-clerk-id',
      email: 'user@cueit.com',
      firstName: 'John',
      lastName: 'Doe',
