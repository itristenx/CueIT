    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    Text("• apps/nova-synth/.env - Nova Synth API configuration")
                    Text("• apps/nova-orbit/.env.local - Nova Orbit portal configuration")
                    Text("• apps/nova-core/.env.local - Nova Core admin configuration")
                    Text("• apps/nova-comms/.env - Nova Comms Slack configuration")
                }
