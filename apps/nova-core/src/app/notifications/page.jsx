...
import { Bell, Plus, Send, Edit, Trash2, RefreshCw, CheckCircle, XCircle, AlertTriangle, MessageSquare, Users, Calendar, Eye, Settings } from 'lucide-react';
export default function NotificationsPage() {
    ...
    return (<AdminLayout>
      <div className="space-y-6">
                    ...
                    {notifications.map((notification) => (<TableRow key={notification.id}>
                        ...
                        <TableCell>
                          <div className="flex space-x-1">
                            {notification.channels.map((channel) => (<Badge key={channel} variant="outline" className="text-xs">
                                {channel}
                              </Badge>))}
                          </div>
                        </TableCell>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  {templates.map((template) => (<Card key={template.id} className="border-2 border-gray-200">
        ...
        {showComposer && (<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <Card className="w-full max-w-2xl mx-4">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    <Label>Type</Label>
                    <Select value={composer.type} onValueChange={(value) => setComposer(Object.assign(Object.assign({}, composer), { type: value }))}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={composer.recipients} onValueChange={(value) => setComposer(Object.assign(Object.assign({}, composer), { recipients: value }))}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
