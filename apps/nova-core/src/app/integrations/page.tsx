...
interface Integration {
  id: string;
  name: string;
  type: 'slack' | 'teams' | 'smtp' | 'helpscout' | 'servicenow' | 'ldap' | 'saml' | 'oauth';
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {integrationTypes.map((type) => {
                ...
                return (
                  <Card key={type.id} className="border-2 border-gray-200 hover:border-gray-300 transition-colors">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {existing ? (
                          <Button 
                            variant="outline" 
                            size="sm" 
                            onClick={() => setActiveIntegration(existing)}
                          >
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          onChange={(e) => setActiveIntegration({
                            ...activeIntegration,
                            config: { ...activeIntegration.config, botToken: e.target.value }
                          })}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setActiveIntegration({
                          ...activeIntegration,
                          config: { ...activeIntegration.config, signingSecret: e.target.value }
                        })}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setActiveIntegration({
                          ...activeIntegration,
                          config: { ...activeIntegration.config, channel: e.target.value }
                        })}
                        placeholder="#support"
                      />
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setActiveIntegration({
                            ...activeIntegration,
                            config: { ...activeIntegration.config, host: e.target.value }
                          })}
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setActiveIntegration({
                            ...activeIntegration,
                            config: { ...activeIntegration.config, port: parseInt(e.target.value) }
                          })}
                          placeholder="587"
                        />
                      </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setActiveIntegration({
                          ...activeIntegration,
                          config: { ...activeIntegration.config, user: e.target.value }
                        })}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          onChange={(e) => setActiveIntegration({
                            ...activeIntegration,
                            config: { ...activeIntegration.config, password: e.target.value }
                          })}
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                        id="secure"
                        checked={activeIntegration.config.secure || false}
                        onChange={(e) => setActiveIntegration({
                          ...activeIntegration,
                          config: { ...activeIntegration.config, secure: e.target.checked }
                        })}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setActiveIntegration({
                          ...activeIntegration,
                          config: { ...activeIntegration.config, baseDN: e.target.value }
                        })}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setActiveIntegration({
                          ...activeIntegration,
                          config: { ...activeIntegration.config, bindDN: e.target.value }
                        })}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          onChange={(e) => setActiveIntegration({
                            ...activeIntegration,
                            config: { ...activeIntegration.config, bindPassword: e.target.value }
                          })}
