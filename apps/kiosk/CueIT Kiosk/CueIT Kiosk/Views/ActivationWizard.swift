...
struct ActivationWizard: View {
    ...
    enum WizardStep: Int, CaseIterable {
        ...
        var title: String {
            switch self {
            case .welcome:
                return "Welcome to QueueIT Kiosk"
        ...
        var subtitle: String {
            ...
            case .serverConnection:
                return "Connect to your organization's QueueIT server"
            case .activation:
                return "Enter your activation code or scan the QR code from the QueueIT Portal"
            case .pinSetup:
